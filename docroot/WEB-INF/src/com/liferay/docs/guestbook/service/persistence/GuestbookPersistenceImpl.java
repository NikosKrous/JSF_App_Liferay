...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	 ...
	 */
	@Override
	public List<Guestbook> filterFindByName(long groupId, String name)
		throws SystemException {
		return filterFindByName(groupId, name, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Guestbook> filterFindByName(long groupId, String name,
		...
		return filterFindByName(groupId, name, start, end, null);
	}
	...
	public List<Guestbook> filterFindByName(long groupId, String name,
		...
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByName(groupId, name, start, end, orderByComparator);
		}
	 ...
	 */
	@Override
	public Guestbook[] filterFindByName_PrevAndNext(long guestbookId,
		...
		try {
			...
			array[0] = filterGetByName_PrevAndNext(session, guestbook, groupId,
					name, orderByComparator, true);

			array[1] = guestbook;

			array[2] = filterGetByName_PrevAndNext(session, guestbook, groupId,
	...
	protected Guestbook filterGetByName_PrevAndNext(Session session,
		Guestbook guestbook, long groupId, String name,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public int filterCountByName(long groupId, String name)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByName(groupId, name);
		}
