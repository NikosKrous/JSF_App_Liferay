...
@ManagedBean
@ViewScoped
// It will stay active on the server and have a known state as long as the
// portlet’s view is being used by the user.
public class GuestbookBacking extends AbstractBacking {
	...
	// The next two methods are called during the Guestbook portlet’s start-up,
	// which creates the default Main guestbook.
	...
	// called directly after the bean’s construction and dependency injection
	// have completed.
	@PostConstruct
	...
	public void editEntry() {          //
		...
		editingGuestbook = false;      //
                                       ...
                                       // These methods use the boolean properties you specified in the guestbook bean to distinguish which view to display.
	...
	}             													// These setters help manage your editingEntry and editingGuestbook variables,
																	//  which aid in the navigation between views.
	...
	public boolean isEditingEntry() { 		  	//
		return editingEntry;					//
												...
												// These methods return the boolean properties set by the setter methods in the previous step.
