...
public class EntryLocalServiceImpl extends EntryLocalServiceBaseImpl {
	...
	// The two following methods are used for finding guestbook entries.
	...
	// This method is used for adding guestbook entries.
	@Override
	public Entry addEntry(Entry entry, long userId) throws PortalException,
			SystemException {
		...
		resourceLocalService.addResources(entry.getCompanyId(),
				entry.getGroupId(), userId, Entry.class.getName(), entryId,
				false, true, true);
	...
	@Override
	public Entry deleteEntry(Entry entry) throws SystemException, PortalException {
	...
	// Returns the number of guestbook entries you've stored.
