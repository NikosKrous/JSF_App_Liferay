...
@ManagedBean
@RequestScoped // The entry bean’s instance is only created when a request is made.
public class EntryBacking extends AbstractBacking {

	private Boolean hasAddPermission;

	// The @ManagedProperty annotation is used to inject dependencies from one managed bean into another.
	...
	public void save() {
		...
		Entry entry = new Entry(guestbookBacking.getSelectedEntry());
		LiferayFacesContext liferayFacesContext = LiferayFacesContext
				.getInstance();
