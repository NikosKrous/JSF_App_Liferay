 ...
 */
public class GuestbookClp extends BaseModelImpl<Guestbook> implements Guestbook {
	public GuestbookClp() {
	}
	...
	public void setGuestbookId(long guestbookId) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, guestbookId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGroupId(long groupId) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, groupId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCompanyId(long companyId) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, companyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserId(long userId) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, userId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUserName(String userName) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, userName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setCreateDate(Date createDate) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_guestbookRemoteModel != null) {
			try {
				...
				method.invoke(_guestbookRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getGuestbookRemoteModel() {
		return _guestbookRemoteModel;
	}

	public void setGuestbookRemoteModel(BaseModel<?> guestbookRemoteModel) {
		_guestbookRemoteModel = guestbookRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _guestbookRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_guestbookRemoteModel,
	...
	public Guestbook toEscapedModel() {
		return (Guestbook)ProxyUtil.newProxyInstance(Guestbook.class.getClassLoader(),
			new Class[] { Guestbook.class }, new AutoEscapeBeanHandler(this));
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GuestbookClp)) {
			return false;
		}

		GuestbookClp guestbook = (GuestbookClp)obj;
